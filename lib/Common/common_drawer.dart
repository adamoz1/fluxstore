  ...
  Widget build(BuildContext context) {
    return Drawer(
      ...
      child: ListView(
        ...
        children: [
           const DrawerHeader(
            padding: EdgeInsets.only(top: 40,left: 15.0,bottom: 20.0,right: 0.0),
              child: ListTile(
          ...
          Container(
            ...
            padding: const EdgeInsets.all(5.0),
            child: ListTile(
              leading: const Icon(Icons.mail_outline_outlined,size: 25,),
          ...
          Container(
            ...
            child:ElevatedButton.icon(
                ...
                label: Text('Theme', style: TextStyle(color: getThemeColor(Get.isDarkMode))),
                style: ElevatedButton.styleFrom(
                  foregroundColor: getThemeColor(Get.isDarkMode),
                  backgroundColor: getThemeColor(!Get.isDarkMode), // Inverted for background
                ),
                icon: Icon(Icons.sunny, color: getThemeColor(Get.isDarkMode)),
