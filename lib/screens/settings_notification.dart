        ...
        children: [
          ListTile(
              ...
              trailing: Switch(
                ...
                onChanged: (bool newValue) {
                  // Update the switch value when it changes
                  setState(() {
                ...
                activeColor: switchValue
                    ? Colors.green
                    : Colors.white60, // Set active color based on switch value
          ...
          ListTile(
              ...
              trailing: Switch(
                ...
                activeColor: switchValue1
                    ? Colors.green
                    : Colors.white60, // Set active color based on switch value
                inactiveTrackColor:
                    switchValue1 ? Colors.green : Colors.white60,
              )),
          ListTile(
              title: const Text(
                'Look screen notifications',
                style: TextStyle(fontSize: 20),
              ),
              subtitle: const Text(
              ...
              trailing: Switch(
                ...
                activeColor: switchValue2
                    ? Colors.green
                    : Colors.white60, // Set active color based on switch value
                inactiveTrackColor:
                    switchValue2 ? Colors.green : Colors.white60,
              )),
        ],
      ),
    );
